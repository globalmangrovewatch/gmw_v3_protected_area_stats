...
protected_agb_hists_file = 'protected_tot_c_hists.json'
...
df_stats.to_csv("gmw_v3_tot_c_protect_area_bounds.csv")
df_stats.to_feather("gmw_v3_tot_c_protect_area_bounds.feather")
xlsx_writer = pandas.ExcelWriter("gmw_v3_tot_c_protect_area_bounds.xlsx", engine='xlsxwriter')
df_stats.to_excel(xlsx_writer, sheet_name='tot_c_hists')
xlsx_writer.save()
